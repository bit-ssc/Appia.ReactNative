...
- (void)applicationDidChangedStatusBarOrientationNotification:(NSNotification *)noti {
  ...
  _browser.dismissBtn.frame = CGRectMake(15, expectBounds.size.height - 44, 30, 30);
  _browser.downloadBtn.frame = CGRectMake(expectBounds.size.width - 45, expectBounds.size.height - 44, 30, 30);
}
