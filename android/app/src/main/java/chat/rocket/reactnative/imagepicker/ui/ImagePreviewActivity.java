...
import chat.rocket.reactnative.imagepicker.util.NavigationBarChangeListener;
import chat.rocket.reactnative.imagepicker.util.Utils;
import chat.rocket.reactnative.imagepicker.view.SuperCheckBox;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                StandardGSYVideoPlayer videoPlayer = mAdapter.getPreVideoPlayer();
                if (videoPlayer != null) {
                    videoPlayer.release();
                }
            }
