...
import com.talkingdata.sdk.TalkingDataSDKPackage;
...
import chat.rocket.reactnative.jsToNative.JSToNativePackage;
import chat.rocket.reactnative.nativeToJS.NativeToJSPackage;
...
public class MainApplication extends Application implements ReactApplication {
  ...
  private final ReactNativeHost mReactNativeHost = new ReactNativeHostWrapper(this, new ReactNativeHost(this) {
    ...
    protected List<ReactPackage> getPackages() {
      ...
      packages.add(new JSToNativePackage());
      packages.add(new NativeToJSPackage());
      packages.add(new TalkingDataSDKPackage());
  ...
  public void onCreate() {
    ...
    PlayerFactory.setPlayManager(Exo2PlayerManager.class);//更改系统内核模式，支持更多格式
