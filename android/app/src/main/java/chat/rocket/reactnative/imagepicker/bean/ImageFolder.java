package chat.rocket.reactnative.imagepicker.bean;
...
public class ImageFolder implements Serializable {
    ...
    public boolean equals(Object o) {
        try {
            ...
            return path != null && name != null && this.path.equalsIgnoreCase(other.path) && this.name.equalsIgnoreCase(other.name);
