...
import chat.rocket.reactnative.imagepicker.adapter.ImagePageAdapter;
import chat.rocket.reactnative.imagepicker.bean.ImageItem;
import chat.rocket.reactnative.imagepicker.util.Utils;
import chat.rocket.reactnative.imagepicker.view.ViewPagerFixed;
...
public abstract class ImagePreviewBaseActivity extends ImageBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        topBar.findViewById(R.id.ll_dir).setVisibility(View.GONE);
