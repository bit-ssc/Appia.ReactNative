package chat.rocket.reactnative.imagepicker.util;
...
public class Utils {
     ...
     * 获取图片或者视频的类型
     */
    public static String getImageItemType(ImageItem imageItem) {
        return imageItem != null ? imageItem.mimeType.split("/")[0] : null;
    }
