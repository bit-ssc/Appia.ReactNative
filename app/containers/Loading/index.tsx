...
export const sendLoadingEvent = ({ visible, onCancel, bgColor }: ILoadingEvent): void =>
	EventEmitter.emit(LOADING_EVENT, { visible, onCancel, bgColor });
...
const Loading = (): React.ReactElement | null => {
	...
	const onEventReceived = ({ visible: _visible, onCancel: _onCancel = null, bgColor: _bgColor = false }: ILoadingEvent) => {
		if (_visible) {
	...
	return (
		<View style={[StyleSheet.absoluteFill, bgColor ? { backgroundColor: '#FFFFFF' } : {}]} testID={LOADING_TEST_ID}>
