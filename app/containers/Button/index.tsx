...
export interface IButtonProps extends PlatformTouchableProps {
	title: string;
	...
	return (
		...
		>
			{loading ? (
				...
				<Text style={[styles.text, { color: textColor, fontSize, alignSelf: 'center' }, styleText]} accessibilityLabel={title}>
					{title}
				</Text>
			)}
		</Touchable>
