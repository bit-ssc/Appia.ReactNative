...
import { DEFAULT_FONT_SETTING, themes } from '../../lib/constants';
...
const Content = React.memo(
	({
		...
		let scale = fontScale;
		if (UserPreferences.getString(DEFAULT_FONT_SETTING) !== 'Follow_System_Setting') {
			scale = 1;
		}
		return (
			<View
				style={[styles.container, disabled && styles.disabled, { height: (heightContainer || BASE_HEIGHT) * scale }]}
				testID={testID}
			>
