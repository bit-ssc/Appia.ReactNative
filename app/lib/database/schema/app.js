	...
	tables: [
		tableSchema({
			...
			columns: [
				...
				{ name: 'room_value_proposition', type: 'string', isOptional: true },
				...
				{ name: 'dname', type: 'string', isOptional: true },
				{ name: 'todoCount', type: 'number', isOptional: true },
				{ name: 'dname', type: 'string', isOptional: true },
				{ name: 'onCallStatus', type: 'boolean', isOptional: true },
				{ name: 'callMsg', type: 'string', isOptional: true },
				{ name: 'bot', type: 'boolean', isOptional: true },
				{ name: 'welcomeMsg', type: 'string', isOptional: true },
				...
				{ name: 'isRoomToDo', type: 'boolean', isOptional: true },
				{ name: 'highTodoCount', type: 'number', isOptional: true },
				{ name: 'defaultTodoCount', type: 'number', isOptional: true },
				{ name: 'like', type: 'boolean', isOptional: true },
				{ name: 'tSearch', type: 'number', isOptional: true }
			]
		}),
		tableSchema({
			name: 'rooms',
			columns: [
				...
				{ name: 'federated', type: 'boolean', isOptional: true },
				{ name: 'rt', type: 'string', isOptional: true },
				{ name: 'rooms', type: 'string', isOptional: true },
				{ name: 'onCallStatus', type: 'boolean', isOptional: true },
				{ name: 'callMsg', type: 'string', isOptional: true },
				{ name: 'bot', type: 'boolean', isOptional: true },
				{ name: 'showAppiaTag', type: 'number', isOptional: true }
		...
		tableSchema({
			...
			columns: [
				...
				{ name: 'survey_status', type: 'boolean', isOptional: true },
				{ name: 'appia_todo', type: 'string', isOptional: true }
			]
		}),
		tableSchema({
			name: 'threads',
		...
		tableSchema({
			...
			columns: [
				...
				{ name: 'tmid', type: 'string', isOptional: true },
				{ name: 'description', type: 'string', isOptional: true },
				{ name: 'is_system_audio', type: 'boolean', isOptional: true },
