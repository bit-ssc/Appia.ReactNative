...
export default class Subscription extends Model {
	...
	@json('announcement', sanitizer) announcement;

	@json('room_value_proposition', sanitizer) roomValueProposition;
	...
	@field('onCallStatus') onCallStatus;

	@field('callMsg') callMsg;

	@field('todoCount') todoCount;

	@field('bot') bot;

	@field('welcomeMsg') welcomeMsg;

	@field('memberName') memberName;

	@field('memberNumber') memberNumber;

	@field('showAppiaTag') showAppiaTag;

	@field('isRoomToDo') isRoomToDo;

	@field('highTodoCount') highTodoCount;

	@field('defaultTodoCount') defaultTodoCount;

	@field('like') like;

	@date('tSearch') tSearch;
}
