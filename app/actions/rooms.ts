...
export interface IRoomsMessageUnread extends Action {
	messageUnread: number;
}

export interface IRoomsChannelUnread extends Action {
	channelUnread: number;
}

export type IRoomsAction = IRoomsRequest & ISetSearch & IRoomsFailure & IRoomsMessageUnread & IRoomsChannelUnread;
...
export function updateMessageUnread(messageUnread: number): IRoomsMessageUnread {
	return {
		type: ROOMS.MESSAGE_UNREAD,
		messageUnread
	};
}

export function updateChannelUnread(channelUnread: number): IRoomsChannelUnread {
	return {
		type: ROOMS.CHANNEL_UNREAD,
		channelUnread
	};
}
