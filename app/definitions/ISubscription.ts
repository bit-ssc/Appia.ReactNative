...
import { IOmnichannelSource, IRoomAnnouncement, RoomID, RoomType } from './IRoom';
...
export interface RoomListSectionHeader {
	headTitle?: string;
	isHeadClose?: boolean;
	rowNum?: number;
	showRowNum?: boolean;
...
export type TSubscriptionModel = ISubscription & Model & RoomListSectionHeader;
