...
const Item = React.memo(({ left, right, text, onPress, testID, current, theme, style }: SidebarItemProps) => (
	<Touch
		key={testID}
		testID={testID}
		onPress={onPress}
		theme={theme}
		style={[styles.item, style, current && { backgroundColor: themes[theme].borderColor }]}
	>
