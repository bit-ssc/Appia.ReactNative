...
describe('Commands', () => {
	...
	beforeEach(() => {
		...
		uut = new Commands_1.Commands(
			(0, ts_mockito_1.instance)(mockedNativeCommandsSender),
			(0, ts_mockito_1.instance)(mockedUniqueIdProvider),
			notificationFactory
		);
	});
	...
	describe('postLocalNotification', () => {
		it('sends to native', () => {
			...
			(0, ts_mockito_1.verify)(
				mockedNativeCommandsSender.postLocalNotification(notification, (0, ts_mockito_1.anyNumber)())
			).called();
		});
